...
$P(X_4=3)=\frac{8^3}{3!}\cdot e^{-8}=\Sexpr{round(dpois(3,lambda=8),4)}$.
\end{frame}
...
$$P(X_7=0)=\frac{10.5^0}{0!}\cdot e^{-10.5}=e^{-10.5}= \Sexpr{round(dpois(0,10.5),7)}$$
\end{itemize}
\end{frame}
...
& \approx & \Sexpr{round(1-ppois(1,21),10)} 
\end{eqnarray*}
\end{itemize}
\end{frame}
