...
curve(  dnorm,
  ...
  main = "Densidad N(0,1); normal estándar"
  )
  abline(v = 0)
  @
...
plot(0:30,dbinom(0:30,30,0.47),xlab="",ylab="",ylim=c(0,0.15),cex=0.5,pch=21,bg="blue",main="B(30,0.47) y N(30*0.47,sqrt(30.0.47*0.53)") 
curve(dnorm(x,mean=30*0.47, sd=sqrt(30*0.47*(1-0.47))),add = TRUE,col="blue")
@
\end{frame}
...
plot(0:300,dpois(0:300,150),xlab="",ylab="",ylim=c(0,0.035),cex=0.5,pch=21,bg="blue",main="Pois(150) y N(150,sqrt(150)") 
curve(dnorm(x,mean=150, sd=sqrt(150)),add = TRUE,col="blue")
@
