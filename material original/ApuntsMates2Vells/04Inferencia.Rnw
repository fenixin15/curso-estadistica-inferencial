\SweaveOpts{prefix.string=./dibujos/04/} 
...
$\overline{X}= \Sexpr{round(mean(reactivo),2)}$ y $\tilde{s}_{X}=\Sexpr{round(sd(reactivo),2)}.$
\item 
...
$$\chi_{n-1,1-\frac{\alpha}{2}}^2= \chi_{29,0.975}^2=\Sexpr{round(qchisq(0.975,29),2)} \mbox{ y }
\chi^2_{n-1,\frac{\alpha}{2}}= \chi_{29,0.025}^2=\Sexpr{round(qchisq(0.025,29),2)}.$$
\item 
...
\left(\Sexpr{round(29*(sd(reactivo))^2/qchisq(0.975,29),2)},\Sexpr{round(29*sd(reactivo)^2/qchisq(0.025,29),2)}\right)$$
\item 
Es decir $P(\Sexpr{round(29*(sd(reactivo))^2/qchisq(0.975,29),2)}\leq \sigma^2\leq
\Sexpr{round(29*(sd(reactivo))^2/qchisq(0.025,29),2)})=0.95.$
\end{itemize}
\end{frame}
...
suma.cuadrados
varianza.muestral <-round((n/(n-1))*(suma.cuadrados/n- media^2),4)
varianza.muestral
@
\end{frame}
...
$\overline{x}=\frac{203+ 229+ 215+ 220+ 223+ 233+ 208+ 228+
        209}{9}=\Sexpr{media}$.
\item La varianza muestral es  $\tilde{s}^2= \frac{9}{8}\left(203^2+229^2+\ldots\right. \left. \ldots + (209)^2\right)-\Sexpr{media}^2=\frac{9}{8}\left(\frac{\Sexpr{suma.cuadrados}}{9}-\Sexpr{round(media^2,4)}\right)=\Sexpr{varianza.muestral}$
