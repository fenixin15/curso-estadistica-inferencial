...
## Gráficos de las funbiones de distribución de una  $Ber(0.25)$
...
<l class="prop"> Propiedad de la carencia de memoria </l>`
...
## Resumen distribución Binomial Negativa $BN(r,p)$
...
* Diremos que una v.a. discreta $X$ con $X(\Omega)=\NN$ tiene distribución de Poisson con parámetro $\lambda>0$, y lo denotaremos
...
\max\{0,n-N_2\}\leq x \leq \min\{n,N_1\} \mbox { con } x\in \mathbf{N}\\
0  & \mbox{en otro caso}\end{array}\right.$$
...
<div class="obsv"> 
En ocasiones se parametriza una v.a. hipergeométrica mediante $N=$número total de bolas, 
$n$=número de extracciones y $p=$ probabilidad de una bola blanca. Así podríamos $H(N,n,p)$ donde $p=\frac{N_1}{N}$, $N=N_1+N_2$.

</div>



## Resumen distribución hipergeométrica  $H(N_1,N_2,n)$.
\scriptsize
