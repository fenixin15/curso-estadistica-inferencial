...
Es decir cuántas  manearas distintas hay para elegir (*choose*) 5 jugadores en un conjunto de 6 jugadores. Todo el mundo diria 
...
Si  son 10 jugadorespara elegir 5 el número de queipos distintos es bastante más grande
...
Como nuestro aficionada tiene un tía que juega mucho al fútbol en su consola  y con los datos que le damos  estima que  la probabilidad de que el Barça gane un clasico cualquiera es
