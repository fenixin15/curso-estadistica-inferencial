...
## Graficas de la  distribución $Ge(p)$
...
Con 10 jugadores  el número de euqipos de  5 distintos es bastante más grande
...
* La probabilidad de fracaso se sule denotar con  $q=1-p$, **sin ningún aviso adicional** con el fin de acortar la escritura de las  fórmulas.
